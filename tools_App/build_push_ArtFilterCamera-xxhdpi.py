...
SOURCE_FOLDER_NAME = "ArtFilterCamera-xhdpi"
OUTPUT_NAME = "ArtFilterCamera-xhdpi-release"
reboot = False
...
def main():
    ...
    parser.add_argument(
        "-d", "--device", type=str, help="Specify device serial number"
    )
    ...
    if do_push:
        push_apk(OUTPUT_NAME, force_stop_package=PACKAGE, reboot=reboot, device_serial=args.device)
