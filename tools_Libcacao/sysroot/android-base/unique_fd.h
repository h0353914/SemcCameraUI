...
// Based on lineage-16.0 version (no fdsan), but adds borrowed_fd for
// compatibility with newer binder/unique_fd.h.
...
// borrowed_fd: a non-owning reference to a file descriptor.
// Like string_view is to string, borrowed_fd is to unique_fd.
// Added for compatibility with newer binder headers.
struct borrowed_fd {
