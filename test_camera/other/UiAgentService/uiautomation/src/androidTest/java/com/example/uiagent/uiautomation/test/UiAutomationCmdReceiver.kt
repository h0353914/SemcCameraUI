...
/**
 * UiAutomation 指令接收器 — 透過 Broadcast 接收指令並執行。
 *
 * 運行方式：
 *   1. 先啟動 Instrumentation 測試保持執行
 *   2. 發送 broadcast 指令：
 *      adb shell am broadcast -a com.example.uiagent.uiautomation.UIAUTOMATION_CMD --es cmd list_elements
 *      adb shell am broadcast -a com.example.uiagent.uiautomation.UIAUTOMATION_CMD --es cmd click_rid --es rid <resource-id>
 */
